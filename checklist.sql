...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 14, 2025 at 06:12 AM
...
INSERT INTO `asignacion` (`idasignacion`, `idmateria`, `idprofesor`) VALUES
(1, 1, '2001'),
(2, 2, '2001'),
(3, 3, '2002'),
(4, 4, '2002'),
...
INSERT INTO `profesor` (`idprofesor`, `nombre`, `apellido`, `email`, `password`) VALUES
('100', 'camilo', 'aguilar', 'camilo@usb', '$2b$12$LG885IBEDu2u34j6haLceudp6KJm7y8rIy3lfeMecR2bxRbSntfFq'),
('2001', 'Paolo', 'Tovar', 'paolo.tovar@usbbog.com', '$2y$10$dlerbx4H5VL15sovLDGpV.b7oFTk90HnTwLYMM2DocfA6ONoxO8a6'),
('2002', 'Mary', 'Rubiano', 'mary.rubiano@usbbog.com', '$2y$10$mDTBBANijNgsEmJMVuzlvOpbFGLJyUraaeOUpFDqG6WjFjZPOOJ56'),
('2003', 'Andres', 'Miranda', 'andres.miranda@usbbog.com', '$2y$10$7HH8.T8fbyoz4UebwDwnF.NXE7VspPw6yofXXSrunZ3yLwqHWM/He');
...
ALTER TABLE `asignacion`
  ...
  ADD KEY `cedulaprofesor` (`idprofesor`);
...
ALTER TABLE `asignacion`
  ...
  ADD CONSTRAINT `fk_asignacion_profesor` FOREIGN KEY (`idprofesor`) REFERENCES `profesor` (`idprofesor`);
